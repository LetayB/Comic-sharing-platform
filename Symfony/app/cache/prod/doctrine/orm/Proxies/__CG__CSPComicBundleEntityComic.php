...
namespace Proxies\__CG__\CSP\ComicBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Comic extends \CSP\ComicBundle\Entity\Comic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'id', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'date', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'title', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'author', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'alt', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'path', '' . "\0" . 'CSP\\ComicBundle\\Entity\\Comic' . "\0" . 'name', 'file');
        }
    ...
    public function getPathName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPathName', array());
